<?php /*a:1:{s:50:"D:\DCAPP\application\ads\view\positions\index.html";i:1542340452;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <!-- 下面是定义标签库 -->
...
<script>
    ...
    layui.config({
        ...
        tableIns = table.render({
            ...
            url: '<?php echo url("ads/positions/index"); ?>',
            method: 'post',
            page: true,
            loading: true,
            limit: 20,
            ...
            cols: [[
                ...
                {field: 'positions_title', minWidth: 180, title: '广告位置名称'},
                {field: 'positions_brief', minWidth: 180, title: '广告位置简要'},
                {field: 'positions_create_time', width: 130, align: 'center', title: '创建日期', templet: function(d) {
                    return new Date(d.positions_create_time*1000).Format("yyyy-MM-dd");
                }},
