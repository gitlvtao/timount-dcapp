<?php /*a:1:{s:48:"D:\DCAPP\application\admin\view\login\index.html";i:1543216958;}*/ ?>
                ...
                <div class="layui-row">
                    ...
                    <div class="layui-col-xs5">
                        <div style="margin-left: 10px;">
                            <img src="" alt="captcha" id="randomCodeImg" class="layadmin-user-login-codeimg"
                                 onclick="javascript:refreshVercode();"/>
                        </div>
                    </div>
                </div>
            </div>
