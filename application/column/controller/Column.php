...
use app\column\model\Column as model;
...
class Column extends Base
{
    ...
    public function columnEdit()
    {
        ...
        return view("columnEdit",['column_list'=>$column_list,'column_id'=>$column_id,'column_image'=>json_encode($column_list,true)]);
    }
